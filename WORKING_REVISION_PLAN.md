...
|---:|---|---|---|---|
| 1 | Aug 24–30 | All 44 SV Basics lessons in six clustered retrieval blocks; include the task/function and Section 6 TODOs in the weak queue | Intent, covergroups, sampling, coverpoints, and bin forms | Rebuild the layered-testbench flow and compile one small coverage example from a blank editor |
...
- [ ] Put the existing task-versus-function and Section 6 TODO items into the
  weakness queue without editing over the current uncommitted notes.
