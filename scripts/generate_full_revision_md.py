...
def get_front_matter():
    return """# SystemVerilog Unified Revision Guide: Data Types and Object-Oriented Programming (OOP)
...
def get_matrix():
    return """## Master Cross-Revision Question Mapping Matrix
...
def get_part_1():
    return """## Part I: Data Types, Representation & Simulation Foundations
...
$$\text{Frequency (MHz)} = \frac{1000}{\text{Period (ns)}}$$
...
def get_part_2():
    return """## Part II: Subroutines & Argument Passing Semantics
...
def get_part_3():
    return """## Part III: Object-Oriented Programming (OOP) in SystemVerilog
...
def get_part_4_to_6():
    return """## Part IV: Practice Code Bug Audit and Code Repairs
