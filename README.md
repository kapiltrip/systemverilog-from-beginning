...
The ordered coverage track now continues through Part 14 with goals/weights,
...
reconstruction, and Part 14's repaired all-sample report plus deterministic
100% wildcard-coverage variant.
