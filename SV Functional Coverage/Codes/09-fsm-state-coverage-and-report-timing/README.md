...
archived as Part 10; the ordered learning sequence later continues through Part
14. [`rzC3`](https://edaplayground.com/x/rzC3) is represented by an exact saved
source capture and a deterministic local variant in Part 14.
