...
lessons continue as Parts 07–14. Intermediate `Kd8_` remains an unarchived FSM
draft; `rzC3` is now represented by Part 14's exact saved source and
deterministic local variant.
